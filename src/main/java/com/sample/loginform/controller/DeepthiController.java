...
public class DeepthiController {
    ...
    @GetMapping("/login")
    public String login() {
        return "login"; // This assumes you have a login.html file in src/main/resources/templates
    }
        
        @GetMapping("/register")
        public String register() {
        	return"register";//this assumes you have a regsiter.html file in src/main/resources/templates
